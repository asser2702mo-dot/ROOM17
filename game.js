...
function updateUI(){
  ...
  if(!state.terminalRead){
    ...
    quest = "ابحث في الصندوق";

  }
  else if(!state.hasKey){

    quest = "اكتشف طريقة فتح الباب";

  }
  else if(!state.generatorFixed){

    quest = "أصلح مولد الطاقة";

  }
  else{

    quest = "اخرج من الغرفة 17";
        ...
        [
          {
            ...
            action: function(){
              ...
              toast("حصلت على بطاقة الوصول +50 🪙");
